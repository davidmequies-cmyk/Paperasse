...
- **`JSON-LD.md`** — blocs schema.org / metas / conversion Ads à récupérer du site live puis réinjecter (+ gabarits de secours).
...
- **Session éditeur (« Claude in Chrome » sur le poste avec l'éditeur Wix Studio)** : phase 0 de `RECETTE.md` (recopier titles/metas/textes/embeds du live), construction Studio, publication. C'est la seule session capable d'agir dans l'éditeur.
