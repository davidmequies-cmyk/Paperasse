...
| `/reunion` | [Copilote de réunion (prépare · retranscrit · argumente)](prompts/agent-19-copilote-reunion.md) | Claude |
| `/halakha` | [Grand Rabbin — Posek séfarade d'Algérie (minhag de Constantine)](prompts/agent-20-rabbin-halakha.md) | Claude + Gemini |
...
Brancher l'abonnement **Claude Max** (via Claude Code) : [`docs/connexion-claude-max.md`](docs/connexion-claude-max.md).
Brancher **Codex** (exécutant dev, revue de PR) : [`docs/connexion-codex.md`](docs/connexion-codex.md).
