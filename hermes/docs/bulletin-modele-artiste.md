# 🎼 Bulletin-modèle — Artiste intermittent (simulation ligne par ligne)

> Gabarit de **simulation** pour l'agent /paie. Exemple chiffré : **3 207 € brut**, artiste annexe 10, CCNSVP, **2026**, **AVEC abattement DFS + taux réduits 70 %**, CDDU ≤ 3 mois.
> ⚠️ **Simulation, pas un bulletin légal.** Le **net est fiable** ; le **coût employeur final dépend de la réduction générale (RGDU)** et de 3 taux propres à l'établissement (AT/MP, prévoyance, fonds santé) → ton **sPAIEctacle/GHS fait foi** pour le centime et la DSN.
> 🔔 **Règle artiste** : toujours demander (1) abattement O/N, (2) catégorie. **Cat. 1 musiciens = DFS 16 %** · **Cat. 2 comédiens/danseurs = DFS 18 %** (2026).

**Assiettes (brut 3 207 €)** : base après DFS = brut × (1 − DFS) ; base CSG/CRDS = brut × 98,25 % = **3 150,88 €** ; tout en tranche 1 (< PMSS 4 005 €).
Règle des bases : **Sécu** = base DFS **puis** taux × 0,70 (taux réduits artistes) · **retraite/AFDAS/prévoyance/CSA** = base DFS (sans 0,70) · **chômage, AGS, Congés Spectacles** = brut plein · **CSG/CRDS** = 98,25 % du brut (jamais abattues).

---

## A) MUSICIEN — Cat. 1, DFS 16 % (base DFS = 2 693,88 €)

| Cotisation | Base | Taux (sal./pat.) | Salarial | Patronal |
|---|---|---|---:|---:|
| Maladie | 2 693,88 | —/13 %×0,70 | — | 245,14 |
...
| Prévoyance *([À VÉRIFIER])* | 2 693,88 | 0,12/0,88 | 3,23 | 23,71 |
| Fonds collectif santé *([À VÉRIFIER])* | 2 693,88 | —/0,77 | — | 20,74 |
| Chômage (CDDU ≤ 3 mois) | 3 207,00 | 2,40/9,50 | 76,97 | 304,67 |
| AGS | 3 207,00 | —/0,25 | — | 8,02 |
| **Congés Spectacles** | 3 207,00 | —/15,50 | — | 497,09 |
| AFDAS | 2 693,88 | —/2,10 | — | 56,57 |
...
## B) COMÉDIEN (ou danseur/lyrique) — Cat. 2, DFS 18 % (base DFS = 2 629,74 €)

| Cotisation | Base | Taux (sal./pat.) | Salarial | Patronal |
|---|---|---|---:|---:|
| Maladie | 2 629,74 | —/13 %×0,70 | — | 239,31 |
...
| Prévoyance *([À VÉRIFIER])* | 2 629,74 | 0,12/0,88 | 3,16 | 23,14 |
| Fonds collectif santé *([À VÉRIFIER])* | 2 629,74 | —/0,77 | — | 20,25 |
| Chômage (CDDU ≤ 3 mois) | 3 207,00 | 2,40/9,50 | 76,97 | 304,67 |
| AGS | 3 207,00 | —/0,25 | — | 8,02 |
| **Congés Spectacles** | 3 207,00 | —/15,50 | — | 497,09 |
| AFDAS | 2 629,74 | —/2,10 | — | 55,22 |
...
---
*Barème et règles : [`../referentiel-paie-spectacle.md`](../referentiel-paie-spectacle.md). Calé sur les bulletins GHS réels de Michel (Neshama 2026). Dernière mise à jour : 2026-06-30.*
