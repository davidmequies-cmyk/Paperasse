...
> 🎭 **Cas artiste (annexe 10), taux réduits 70 % + DFS, cadre légal complet : voir [`../referentiel-paie-spectacle.md`](../referentiel-paie-spectacle.md).** NB : pour le **chômage**, plus de distinction cachet isolé/groupé depuis 2016 → **1 cachet = 12 h**.
> 🔔 **RÈGLE — ARTISTE** : avant tout calcul pour un **artiste**, **toujours demander** (1) si l'**abattement (DFS)** est appliqué, (2) si oui la **catégorie** : Cat. 2 (comédien/lyrique/danseur) = **18 %** 2026 · Cat. 1 (musicien/choriste/chef d'orch./régisseur) = **16 %** 2026. Ne jamais supposer. (Pas de question pour un technicien.)
